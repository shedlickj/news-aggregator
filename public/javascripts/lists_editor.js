...
// All non-GET requests will add the authenticity token
  // if not already present in the data packet
	 ...
	 $('.list_create_name_error').hide(); 
	 
	 $(".new_list_submit").click(function(event) {
	 	event.preventDefault();
	 	$.post($(this).attr("href"), $("#list_form").serialize(), function(data) {
			return false;
		});
	 });
	 ...
	 $(".list_edit_submit").click(function(event){
         event.preventDefault();
